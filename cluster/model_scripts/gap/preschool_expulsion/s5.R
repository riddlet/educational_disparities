...
df %>% filter(metric == 'preschool_expulsion', grouping_5=='g_5') -> subdat
...
save(m, file='/home/triddle/educational_disparities/cluster/gap/preschool_expulsion/output/s5.rdata')
