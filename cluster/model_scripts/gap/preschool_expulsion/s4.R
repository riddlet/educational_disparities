...
df %>% filter(metric == 'preschool_expulsion', grouping_5=='g_4') -> subdat
...
save(m, file='/home/triddle/educational_disparities/cluster/gap/preschool_expulsion/output/s4.rdata')
