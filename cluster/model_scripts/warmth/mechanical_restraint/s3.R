...
df %>% filter(metric == 'mechanical_restraint', grouping_10=='g_3') -> subdat
...
save(m, file='/home/triddle/educational_disparities/cluster/bias/mechanical_restraint/output/s3.rdata')
