...
df %>% filter(metric == 'in_school_arrest', grouping_10=='g_6') -> subdat
...
save(m, file='/home/triddle/educational_disparities/cluster/bias/in_school_arrest/output/s6.rdata')
