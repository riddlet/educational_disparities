...
df %>% filter(metric == 'expulsion_0_tolerance', grouping_10=='g_4') -> subdat
...
save(m, file='/home/triddle/educational_disparities/cluster/bias/expulsion_0_tolerance/output/s4.rdata')
