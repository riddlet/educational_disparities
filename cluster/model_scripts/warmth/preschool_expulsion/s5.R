...
df %>% filter(metric == 'preschool_expulsion', grouping_10=='g_5') -> subdat
...
save(m, file='/home/triddle/educational_disparities/cluster/bias/preschool_expulsion/output/s5.rdata')
