...
df %>% filter(metric == 'expulsion_wo_ed', grouping_10=='g_10') -> subdat
...
save(m, file='/home/triddle/educational_disparities/cluster/bias/expulsion_wo_ed/output/s10.rdata')
