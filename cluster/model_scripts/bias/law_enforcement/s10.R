...
df %>% filter(metric == 'law_enforcement', grouping_10=='g_10') -> subdat
...
save(m, file='/home/triddle/educational_disparities/cluster/bias/law_enforcement/output/s10.rdata')
