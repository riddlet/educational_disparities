...
df %>% filter(metric == 'mechanical_restraint', grouping_10=='g_4') -> subdat
...
save(m, file='/home/triddle/educational_disparities/cluster/bias/mechanical_restraint/output/s4.rdata')
