...
df %>% filter(metric == 'physical_restraint', grouping_10=='g_8') -> subdat
...
save(m, file='/home/triddle/educational_disparities/cluster/bias/physical_restraint/output/s8.rdata')
