...
df %>% filter(metric == 'physical_restraint', grouping_10=='g_1') -> subdat
...
save(m, file='/home/triddle/educational_disparities/cluster/bias/physical_restraint/output/s1.rdata')
