...
base_path <- '/Users/travis/Documents/gits/educational_disparities/cluster/output/mw_2013uclaexcl_pca/'
...
for (i in metrics){
  ...
  j <- 1
  posterior_combo <- array(0, dim=c(24,4000,length(files)))
  ...
  plot_path <- '/Users/travis/Documents/gits/educational_disparities/figs/individual_models/mw_2013uclaexcl_pca/bias.jpeg'
  ...
  plot_path <- '/Users/travis/Documents/gits/educational_disparities/figs/individual_models/mw_2013uclaexcl_pca/bias_OR.jpeg'
  ...
  plot_path <- '/Users/travis/Documents/gits/educational_disparities/figs/individual_models/mw_2013uclaexcl_pca/bias_OR_slope.jpeg'
...
for (i in metrics){
  ...
  j <- 1
  posterior_combo <- array(0, dim=c(24,4000,length(files)))
  raw_rate <- data.frame(county_id=NA, nschools=NA, weighted_explicit_diff=NA, group=NA, nincidents=NA, nstudents=NA, rate=NA)
  if(length(files)>1){
    for (k in files){
      #print(i)
      load(paste(pth,k,sep=''))
  ...
  newdat <- expand.grid(group = rownames(table(m$data$group)),
                        ...
                        dissim=0,
                        density=0,
                        weighted_explicit_diff = seq(-2,2,.25),
                        number=0,
                        total_number=1)
  y_hat <- rstanarm::posterior_linpred(m, newdata = newdat, re.form=~0, transform=T)
  ...
  posterior_distribution %>%
    ...
    group_by(group, weighted_explicit_diff) %>%
    summarise(est = mean(value),
              lower = quantile(value, .025),
              upper = quantile(value, .975)) %>%
    ungroup() %>%
  ...
  ggplot(plot.dat, aes(x=weighted_explicit_diff, y=est, group=group)) +
    geom_line(aes(color=group)) +
    geom_ribbon(aes(ymin=lower, ymax=upper), alpha=.15) +
    theme_classic() +
    facet_wrap(~metric, scales = 'free') -> plot
  
  plot_path <- '/Users/travis/Documents/gits/educational_disparities/figs/individual_models/mw_2013uclaexcl_pca/warmth.jpeg'
  ...
  #   facet_wrap(~metric, scales = 'free') -> plot
  # 
  # plot_path <- '/Users/travis/Documents/gits/educational_disparities/figs/individual_models/mw_2013uclaexcl_pca/warmth_wdata.jpeg'
  # 
  # ggsave(filename=plot_path, plot)
  ...
  posterior_distribution %>%
    ...
    spread(group, value) %>%
    mutate(ratio = black/white) %>%
    select(weighted_explicit_diff, sample, ratio) %>%
    group_by(weighted_explicit_diff) %>%
    summarise(est = mean(ratio),
              lower = quantile(ratio, .025),
              upper = quantile(ratio, .975)) %>%
    ungroup() %>%
    mutate(metric=i) %>%
    rbind(plot.dat2) %>% 
    filter(!is.na(weighted_explicit_diff)) -> plot.dat2
  
  raw_rate %>%
    select(county_id, nschools, weighted_explicit_diff, group, rate) %>%
    spread(group, rate) %>%
    mutate(odds_r = black/white) -> raw_or
  
  ggplot(plot.dat2, aes(x=weighted_explicit_diff, y=est)) +
    geom_line() +
    geom_ribbon(aes(ymin=lower, ymax=upper), alpha=.15) +
    theme_classic() +
    facet_wrap(~metric, scales='free') -> plot
  
  plot_path <- '/Users/travis/Documents/gits/educational_disparities/figs/individual_models/mw_2013uclaexcl_pca/warmth_OR.jpeg'
  ...
  # ggplot(plot.dat2, aes(x=weighted_explicit_diff, y=est)) +
  #   geom_point(data=raw_or, aes(x=weighted_explicit_diff, y=odds_r, size=nschools,
  #                               color=mercer_county, alpha=mercer_county)) +
  #   geom_line() +
  #   geom_ribbon(aes(ymin=lower, ymax=upper), alpha=.15) +
  #   theme_classic() +
  ...
  plot_path <- '/Users/travis/Documents/gits/educational_disparities/figs/individual_models/mw_2013uclaexcl_pca/warmth_OR_slope.jpeg'
...
for (i in metrics){
  ...
  plot_path <- '/Users/travis/Documents/gits/educational_disparities/figs/individual_models/mw_uclaexcl_diff/bias.jpeg'
  ...
  plot_path <- '/Users/travis/Documents/gits/educational_disparities/figs/individual_models/mw_uclaexcl_diff/bias_OR.jpeg'
  ...
  plot_path <- '/Users/travis/Documents/gits/educational_disparities/figs/individual_models/mw_uclaexcl_diff/bias_OR_slope.jpeg'
...
for (i in metrics){
  ...
  plot_path <- '/Users/travis/Documents/gits/educational_disparities/figs/individual_models/mw_uclaexcl_diff/warmth.jpeg'
  ...
  plot_path <- '/Users/travis/Documents/gits/educational_disparities/figs/individual_models/mw_uclaexcl_diff/warmth_OR.jpeg'
  ...
  plot_path <- '/Users/travis/Documents/gits/educational_disparities/figs/individual_models/mw_uclaexcl_diff/warmth_OR_slope.jpeg'
  
  ggsave(filename=plot_path, plot)
}


# teacher bias w/ explicit difference score
base_path <- '/Users/travis/Documents/gits/educational_disparities/cluster/output/teacher_metrics_expdiff/'
plot.dat <- data.frame(group = NA, county_bias = NA, est = NA, lower = NA, upper=NA, metric = NA)
plot.dat2 <- data.frame(county_bias = NA, est = NA, lower=NA, upper=NA, metric=NA)
plot.dat3 <- data.frame(est=NA, lower=NA, upper=NA, metric=NA)
...
for (i in metrics){
  ...
  plot_path <- '/Users/travis/Documents/gits/educational_disparities/figs/individual_models/teacher_metrics_expdiff/bias.jpeg'
  ...
  plot_path <- '/Users/travis/Documents/gits/educational_disparities/figs/individual_models/teacher_metrics_expdiff/bias_OR.jpeg'
  ...
  #   facet_wrap(~metric, scales='free') -> plot
  # 
  # plot_path <- '/Users/travis/Documents/gits/educational_disparities/figs/individual_models/teacher_metrics_expdiff/bias_OR_wdata.jpeg'
  ...
  plot_path <- '/Users/travis/Documents/gits/educational_disparities/figs/individual_models/teacher_metrics_expdiff/bias_OR_slope.jpeg'
  
  ggsave(filename=plot_path, plot)
}


#teacher warmth w/ explicit difference score
plot.dat <- data.frame(group = NA, county_warmth = NA, est = NA, lower = NA, upper=NA, metric = NA)
plot.dat2 <- data.frame(county_warmth = NA, est = NA, lower=NA, upper=NA, metric=NA)
plot.dat3 <- data.frame(est=NA, lower=NA, upper=NA, metric=NA)
...
for (i in metrics){
  ...
  plot_path <- '/Users/travis/Documents/gits/educational_disparities/figs/individual_models/teacher_metrics_expdiff/warmth.jpeg'
  ...
  plot_path <- '/Users/travis/Documents/gits/educational_disparities/figs/individual_models/teacher_metrics_expdiff/warmth_OR.jpeg'
  ...
  #   facet_wrap(~metric, scales='free') -> plot
  # 
  # plot_path <- '/Users/travis/Documents/gits/educational_disparities/figs/individual_models/teacher_metrics_expdiff/warmth_OR_wdata.jpeg'
  # 
  # ggsave(filename=plot_path, plot)  
  ...
  plot_path <- '/Users/travis/Documents/gits/educational_disparities/figs/individual_models/teacher_metrics_expdiff/warmth_OR_slope.jpeg'
  
  ggsave(filename=plot_path, plot)
}


#weighted bias w/ 3-way interaction
base_path <- '/Users/travis/Documents/gits/educational_disparities/cluster/output/metrics_weighted_3way/'
plot.dat <- data.frame(group = NA, weighted_bias = NA, est = NA, lower = NA, upper=NA, metric = NA)
plot.dat2 <- data.frame(weighted_bias = NA, est = NA, lower=NA, upper=NA, metric=NA)
plot.dat3 <- data.frame(est=NA, lower=NA, upper=NA, metric=NA)
plot.dat4 <- data.frame(est=NA, lower=NA, upper=NA, metric=NA)
...
for (i in metrics){
  ...
  plot_path <- '/Users/travis/Documents/gits/educational_disparities/figs/individual_models/metrics_weighted_3way/bias.jpeg'
  ...
  plot_path <- '/Users/travis/Documents/gits/educational_disparities/figs/individual_models/metrics_weighted_3way/bias_wdata.jpeg'
  ...
  plot_path <- '/Users/travis/Documents/gits/educational_disparities/figs/individual_models/metrics_weighted_3way/bias_OR.jpeg'
  ...
  plot_path <- '/Users/travis/Documents/gits/educational_disparities/figs/individual_models/metrics_weighted_3way/bias_OR_wdata.jpeg'
  ...
  data.frame(est=mean(p_cons[13,]),
    ...
    rbind(plot.dat4) %>%
    filter(!is.na(est)) %>%
    mutate(metric=reorder(metric, est)) -> plot.dat4
  
  ggplot(plot.dat4, aes(x=metric, y=est)) +
    geom_point() +
    geom_errorbar(aes(ymin=lower, ymax=upper)) +
    theme_classic() +
    coord_flip() +
  ...
  plot_path <- '/Users/travis/Documents/gits/educational_disparities/figs/individual_models/metrics_weighted_3way/bias_OR_slope.jpeg'
  ...
  plot_path <- '/Users/travis/Documents/gits/educational_disparities/figs/individual_models/metrics_weighted_3way/3way_interaction.jpeg'
  
  ggsave(filename=plot_path, plot)
  
}

#weighted warmth w/3-way interaction
plot.dat <- data.frame(group = NA, weighted_warmth = NA, est = NA, lower = NA, upper=NA, metric = NA)
plot.dat2 <- data.frame(weighted_warmth = NA, est = NA, lower=NA, upper=NA, metric=NA)
plot.dat3 <- data.frame(est=NA, lower=NA, upper=NA, metric=NA)
plot.dat4 <- data.frame(est=NA, lower=NA, upper=NA, metric=NA)
...
for (i in metrics){
  ...
  plot_path <- '/Users/travis/Documents/gits/educational_disparities/figs/individual_models/metrics_weighted_3way/warmth.jpeg'
  ...
  plot_path <- '/Users/travis/Documents/gits/educational_disparities/figs/individual_models/metrics_weighted_3way/warmth_wdata.jpeg'
  ...
  plot_path <- '/Users/travis/Documents/gits/educational_disparities/figs/individual_models/metrics_weighted_3way/warmth_OR.jpeg'
  ...
  plot_path <- '/Users/travis/Documents/gits/educational_disparities/figs/individual_models/metrics_weighted_3way/warmth_OR_wdata.jpeg'
  ...
  plot_path <- '/Users/travis/Documents/gits/educational_disparities/figs/individual_models/metrics_weighted_3way/warmth_OR_slope.jpeg'
  ...
  if(i=='oos_susp'){
    ...
    posterior_distribution %>%
      select(group, weighted_bias, weighted_warmth, sample, value, index) %>%
      mutate(weighted_bias = factor(weighted_bias, levels = c(-1, 0, 1),
                                    labels=c('low', 'middle', 'high'))) %>%
      group_by(group, weighted_bias, weighted_warmth) %>%
      summarise(est = mean(value),
                lower = quantile(value, .025),
                upper = quantile(value, .975)) %>%
      ungroup() %>%
      filter(!is.na(group)) -> plot.interaction
    
    ggplot(plot.interaction, aes(x=weighted_warmth, y=est, group=group)) +
      geom_line(aes(color=group)) +
      geom_ribbon(aes(ymin=lower, ymax=upper), alpha=.15) +
      theme_classic() +
      facet_wrap(~weighted_bias) -> plot
    
    plot_path <- '/Users/travis/Documents/gits/educational_disparities/figs/individual_models/metrics_weighted_3way/warmth_bias_slope.jpeg'
    
    ggsave(filename=plot_path, plot)
    
    posterior_distribution %>%
      select(group, weighted_bias, weighted_warmth, sample, value) %>%
      mutate(weighted_bias = factor(weighted_bias, levels = c(-1, 0, 1),
                                    labels=c('low', 'middle', 'high'))) %>%
      spread(group, value) %>%
      mutate(ratio = black/white) %>%
      select(weighted_bias, weighted_warmth, sample, ratio) %>%
      group_by(weighted_bias, weighted_warmth) %>%
      summarise(est = mean(ratio),
                lower = quantile(ratio, .025),
                upper = quantile(ratio, .975)) %>%
      ungroup() %>%
      filter(!is.na(weighted_warmth)) -> plot.interaction_or

    ggplot(plot.interaction_or, aes(x=weighted_warmth, y=est)) +
      geom_line() +
      geom_ribbon(aes(ymin=lower, ymax=upper), alpha=.15) +
      theme_classic() +
      facet_wrap(~weighted_bias) -> plot
    
    plot_path <- '/Users/travis/Documents/gits/educational_disparities/figs/individual_models/metrics_weighted_3way/warmth_bias_OR.jpeg'
